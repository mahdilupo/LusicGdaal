...
module.exports = {
	...
	options: [{
		"StringChoices": {
			...
			choices: [
				/*
blues, oldgaming, persian Hip-Hop, remixes, rock, strange-fruits-gaming
      */
				["Blues Mix", "blues"],
				["Charts Mix", "charts"],
				["Chill Mix", "chill"],
				...
				["persian Hip-Hop Mix", "persian Hip-Hop"],
				["Remixes Mix", "remixes"],
				["Rock Mix", "rock"],
	...
	run: async (client, interaction) => {
		try {
			...
			if (args[0]) {
				...
				//persian Hip-Hop
				if (args[0].toLowerCase().startsWith("p")) link = "https://open.spotify.com/playlist/37i9dQZF1E36WWDQ6fu2XT?si=UfFTXSjuSqmg0E6fMFpmig&utm";
				//default
				if (args[0].toLowerCase().startsWith("d")) link = "https://open.spotify.com/playlist/37i9dQZF1E36WWDQ6fu2XT?si=UfFTXSjuSqmg0E6fMFpmig&utm";
