...
function onCoolDown(message, command) {
   ...
   */
   ...
   async function swap_pages(client, message, description, TITLE) {
     ...
     let button_back = new MessageButton().setStyle('SECONDARY').setCustomId('1').setEmoji("833802907509719130").setLabel("Back")
     let button_home = new MessageButton().setStyle('SECONDARY').setCustomId('2').setEmoji("🏠").setLabel("Home")
     let button_forward = new MessageButton().setStyle('SECONDARY').setCustomId('3').setEmoji('832598861813776394').setLabel("Forward")
